...
We want to know if people tip driver from the company Chicago Independents more than other driver of other companies. I created a contingency table and a proportion table to examine the data. Then, I created a bar plot to check the relationship between tip rates and companies.
